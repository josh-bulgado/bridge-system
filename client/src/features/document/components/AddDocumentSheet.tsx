...
interface AddDocumentSheetProps {
  onAddDocument: (
    document: Omit<AddDocumentFormValues, "requirements"> & {
      requirements: string[];
    },
  ) => void;
}

export function AddDocumentSheet({ onAddDocument }: AddDocumentSheetProps) {
  ...
  const onSubmit = (data: AddDocumentFormValues) => {
    ...
    // Call the parent function to handle the data
